...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.author_address'
        db.add_column(u'postoffice_message', 'author_address',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='sentmail', null=True, to=orm['postoffice.Address']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.author_address'
        db.delete_column(u'postoffice_message', 'author_address_id')
    ...
    models = {
        ...
        u'postoffice.message': {
            ...
            'author_address': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sentmail'", 'null': 'True', 'to': u"orm['postoffice.Address']"}),
